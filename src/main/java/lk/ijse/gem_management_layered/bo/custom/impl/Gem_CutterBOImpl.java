...
public class Gem_CutterBOImpl implements Gem_CutterBO {
    ...
    public boolean saveCutter(Gem_CutterDTO dto) throws SQLException, ClassNotFoundException {
        ...
        return gemCutterDAO.save(
                new Gem_Cutter(dto.getCutterName(), dto.getContact(), dto.getAddress())
        );
    }
    ...
    public boolean updateCutter(Gem_CutterDTO dto) throws SQLException, ClassNotFoundException {
        ...
        return gemCutterDAO.update(
                new Gem_Cutter(dto.getCutterId(), dto.getCutterName(), dto.getContact(), dto.getAddress())
        );
    }
    ...
    @Override
    public Gem_CutterDTO searchCutter(String id) throws SQLException, ClassNotFoundException {

        Gem_Cutter cutter = gemCutterDAO.search(id);

        if(cutter != null){
            return new Gem_CutterDTO(
                    cutter.getCutterId(),
